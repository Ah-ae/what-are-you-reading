...
export default function HeaderLayout({ backButtonText = '뒤로', leftItem, title, rightItem }: Props) {
  return (
    <header
      className={`w-full ${MAX_WIDTH} h-14 fixed top-0 left-1/2 transform -translate-x-1/2 p-4 flex justify-center items-center bg-gray-50 dark:bg-zinc-700 border-b border-gray-200 dark:border-zinc-600 z-10`}
    >
